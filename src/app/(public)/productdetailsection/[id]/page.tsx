...
import { useGetSingleProduct } from "@/app/features/products/hook";
...
const Page = () => {
  ...
  const handleWishlistToggle = () => {
    ...
    if (product) {
      ...
      toast.success(isCurrentlyLiked ? "Removed from wishlist" : "Added to wishlist", { transition: Bounce });
    }
  };
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-950 via-purple-950/20 to-slate-950 text-white">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-linear-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 py-4 rounded-xl font-bold text-lg transition-all shadow-lg hover:shadow-purple-500/50"
              >
